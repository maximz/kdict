#!/usr/bin/env python
#
# kdict documentation build configuration file, created by sphinx-quickstart.
#
...
version = kdict.__version__
# The full version, including alpha/beta/rc tags.
release = kdict.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(kdict.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "kdict/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/kdict/blob/%s/%s" % (tag, filename)
